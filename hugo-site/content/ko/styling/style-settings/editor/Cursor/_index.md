...
대상 CSS 변수: `var(--flexcyon-cursor-duration)`

기본값: 42.5 (ms)

### 부드러운 커서 타이밍 함수

대상 CSS 변수: `var(--flexcyon-cursor-timing-fn)`

기본값: ease-in

### 부드러운 커서 최소 폭

대상 CSS 변수: `var(--flexcyon-cursor-min-width)`

기본값: unset

### Vim 블록 커서 깜빡임 비활성화

대상 CSS 클래스: `var(--flexcyon-disable-vim-cursor-blink)`
