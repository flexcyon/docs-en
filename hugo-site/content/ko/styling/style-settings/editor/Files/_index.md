...
대체 폴더 스타일은 활성 파일 항목에 패딩을 추가하고, 활성 폴더의 접기 아이콘과 테두리를
파랑으로 만듭니다.
...
### Nav Header와 다른 콘텐츠의 순서 뒤집기

Nav Header를 다른 콘텐츠 아래에 배치합니다. 예를 들어 새 노트 아이콘과 그 밖의
아이콘들을 파일 탐색기 아래에 배치합니다.

대상 CSS 변수: `var(--flexcyon-reverse-workspace-content)`
