...
- Added callout metadata utilities for:
  ...
  - Apply 제목 1 to 6 styles for title
...
- Added option to blur inactive 캔버스 nodes for core 캔버스 plugin

- Editor background changes now affect the core 캔버스 plugin.

  - May need app reload/restart for Style Settings changes to show up in the 캔버스
